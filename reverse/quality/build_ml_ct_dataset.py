...
def main():
    ...
    ap.add_argument("--at3tool-dir", required=True)
    args = ap.parse_args()
    ...
    for wav in wavs:
        ...
        for i in range(num_frames):
            ...
            for qu in range(num_qu):
                ...
                wl_enc = d["wordlen"][qu][0]
                ct_tgt = f["spec_tab"][qu]
                X_list.append([log_energy, float(sf_enc), float(wl_enc)])
                Y_list.append(float(ct_tgt))
                Q_list.append(qu)
